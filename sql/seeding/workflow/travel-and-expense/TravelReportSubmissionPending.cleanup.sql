/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelReportSubmissionPending.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelReportSubmissionPending';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - TravelReportSubmissionPending';  -- FIXED -- do not change
