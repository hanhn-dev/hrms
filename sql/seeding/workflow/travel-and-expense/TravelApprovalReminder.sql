/* =============================================================================
   Create a test workflow for the Travel module's TravelApprovalReminder page
   ...
   Travel approval reminder workflow. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./TravelApprovalReminder.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelApprovalReminder';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel - TravelApprovalReminder';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelApprovalReminder.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
