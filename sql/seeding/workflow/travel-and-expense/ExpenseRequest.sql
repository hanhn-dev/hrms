/* =============================================================================
   Create a test workflow for the Expense & Reimbursement module's ExpenseRequest page
   ...
   Expense request approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./ExpenseRequest.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ExpenseRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Expense & Reimbursement - ExpenseRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ExpenseRequest.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
