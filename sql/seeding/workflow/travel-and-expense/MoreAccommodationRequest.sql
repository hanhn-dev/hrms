/* =============================================================================
   ...
   To remove what this script created, see ./MoreAccommodationRequest.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'MoreAccommodationRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - MoreAccommodationRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run MoreAccommodationRequest.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
