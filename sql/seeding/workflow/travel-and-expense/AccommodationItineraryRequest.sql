/* =============================================================================
   ...
   AccommodationItineraryRequest page
   ...
   To remove what this script created, see ./AccommodationItineraryRequest.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'AccommodationItineraryRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - AccommodationItineraryRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run AccommodationItineraryRequest.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
