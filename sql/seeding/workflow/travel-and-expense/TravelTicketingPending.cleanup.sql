/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelTicketingPending.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelTicketingPending';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - TravelTicketingPending';  -- FIXED -- do not change
