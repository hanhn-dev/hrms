/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelReportRevision.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelReportRevision';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - TravelReportRevision';  -- FIXED -- do not change
