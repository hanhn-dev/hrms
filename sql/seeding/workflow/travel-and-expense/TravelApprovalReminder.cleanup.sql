/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelApprovalReminder.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelApprovalReminder';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel - TravelApprovalReminder';  -- FIXED -- do not change
