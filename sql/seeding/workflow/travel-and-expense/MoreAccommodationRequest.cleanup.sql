/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/MoreAccommodationRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'MoreAccommodationRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - MoreAccommodationRequest';  -- FIXED -- do not change
