/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/ExpenseRequestReassign.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ExpenseRequestReassign';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - ExpenseRequestReassign';  -- FIXED -- do not change
