/* =============================================================================
   Create a test workflow for the Travel & Expense module's TravelRequestStalled
   page
   ...
   To remove what this script created, see ./TravelRequestStalled.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelRequestStalled';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - TravelRequestStalled';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelRequestStalled.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
