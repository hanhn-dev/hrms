/* =============================================================================
   ...
   To remove what this script created, see ./TravelReportCompletion.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelReportCompletion';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - TravelReportCompletion';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelReportCompletion.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
