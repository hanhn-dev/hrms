/* =============================================================================
   Create a test workflow for the Travel & Expense module's
   TravelRequestAcknowledgementPending page
   ...
   IsWorkflowAvailable = 1 confirmed (Travel & Expense module).
   ...
   To remove what this script created, see ./TravelRequestAcknowledgementPending.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelRequestAcknowledgementPending';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - TravelRequestAcknowledgementPending';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelRequestAcknowledgementPending.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
