/* =============================================================================
   ...
   To remove what this script created, see ./ExpenseRequestReassign.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ExpenseRequestReassign';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - ExpenseRequestReassign';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ExpenseRequestReassign.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
