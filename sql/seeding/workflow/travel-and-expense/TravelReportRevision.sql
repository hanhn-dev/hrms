/* =============================================================================
   Create a test workflow for the Travel & Expense module's TravelReportRevision
   page
   ...
   To remove what this script created, see ./TravelReportRevision.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelReportRevision';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - TravelReportRevision';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelReportRevision.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
