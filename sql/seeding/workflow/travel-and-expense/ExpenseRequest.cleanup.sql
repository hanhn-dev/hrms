/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/ExpenseRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ExpenseRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Expense & Reimbursement - ExpenseRequest';  -- FIXED -- do not change
