/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelBookingComplete.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelBookingComplete';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - TravelBookingComplete';  -- FIXED -- do not change
