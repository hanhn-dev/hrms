/* =============================================================================
   Create a test workflow for the Travel module's TravelRequestReassign page
   ...
   Travel request reassign approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./TravelRequestReassign.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelRequestReassign';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel - TravelRequestReassign';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelRequestReassign.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
