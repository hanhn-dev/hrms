/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelReport.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelReport';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel - TravelReport';  -- FIXED -- do not change
