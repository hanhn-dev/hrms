/* =============================================================================
   Create a test workflow for the Travel module's TravelRescheduleRequest page
   ...
   Travel reschedule request approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./TravelRescheduleRequest.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelRescheduleRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel - TravelRescheduleRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelRescheduleRequest.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
