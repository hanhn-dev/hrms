/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/AccommodationItineraryRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'AccommodationItineraryRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - AccommodationItineraryRequest';  -- FIXED -- do not change
