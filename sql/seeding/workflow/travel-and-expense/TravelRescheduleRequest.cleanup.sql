/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelRescheduleRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelRescheduleRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel - TravelRescheduleRequest';  -- FIXED -- do not change
