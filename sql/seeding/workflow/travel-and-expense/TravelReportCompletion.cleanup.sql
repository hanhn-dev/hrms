/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelReportCompletion.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelReportCompletion';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - TravelReportCompletion';  -- FIXED -- do not change
