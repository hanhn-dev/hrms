/* =============================================================================
   Create a test workflow for the Travel & Expense module's TravelBookingComplete
   page
   ...
   To remove what this script created, see ./TravelBookingComplete.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelBookingComplete';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - TravelBookingComplete';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelBookingComplete.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
