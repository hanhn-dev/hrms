/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelRequestAcknowledgementPending.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelRequestAcknowledgementPending';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - TravelRequestAcknowledgementPending';  -- FIXED -- do not change
