/* =============================================================================
   ...
   To remove what this script created, see ./TravelTicketingPending.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TravelTicketingPending';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Travel & Expense - TravelTicketingPending';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TravelTicketingPending.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
