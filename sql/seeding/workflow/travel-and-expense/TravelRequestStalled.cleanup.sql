/* =============================================================================
   Remove the TEST workflow created by travel-and-expense/TravelRequestStalled.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TravelRequestStalled';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Travel & Expense - TravelRequestStalled';  -- FIXED -- do not change
