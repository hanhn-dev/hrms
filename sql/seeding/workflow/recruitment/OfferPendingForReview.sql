/* =============================================================================
   Create a test workflow for the Recruitment module's OfferPendingForReview page
   ...
   Offer pending for review approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./OfferPendingForReview.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'OfferPendingForReview';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - OfferPendingForReview';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run OfferPendingForReview.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
