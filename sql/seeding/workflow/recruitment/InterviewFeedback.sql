/* =============================================================================
   Create a test workflow for the Recruitment module's InterviewFeedback page
   ...
   To remove what this script created, see ./InterviewFeedback.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'InterviewFeedback';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - InterviewFeedback';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run InterviewFeedback.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
