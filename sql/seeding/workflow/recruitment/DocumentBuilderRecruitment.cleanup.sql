/* =============================================================================
   Remove the TEST workflow created by recruitment/DocumentBuilderRecruitment.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'DocumentBuilderRecruitment';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - DocumentBuilderRecruitment';  -- FIXED -- do not change
