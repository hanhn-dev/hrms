/* =============================================================================
   Remove the TEST workflow created by recruitment/RA-InitiateReallocation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RA-InitiateReallocation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - RA-InitiateReallocation';  -- FIXED -- do not change
