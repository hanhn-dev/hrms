/* =============================================================================
   Create a test workflow for the Recruitment module's BudgetApproval page
   ...
   To remove what this script created, see ./BudgetApproval.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'BudgetApproval';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - BudgetApproval';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run BudgetApproval.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
