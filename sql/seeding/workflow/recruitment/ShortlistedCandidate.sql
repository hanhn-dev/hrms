/* =============================================================================
   Create a test workflow for the Recruitment module's ShortlistedCandidate page
   ...
   See pagetitle-reference.md -- Recruitment also supports role-based approvers
   ('B'/'D'/'H'/'M') as an alternative to this script's engine.
   ...
   To remove what this script created, see ./ShortlistedCandidate.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ShortlistedCandidate';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - ShortlistedCandidate';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ShortlistedCandidate.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
