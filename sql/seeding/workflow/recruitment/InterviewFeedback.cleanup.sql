/* =============================================================================
   Remove the TEST workflow created by recruitment/InterviewFeedback.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'InterviewFeedback';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - InterviewFeedback';  -- FIXED -- do not change
