/* =============================================================================
   Remove the TEST workflow created by recruitment/OfferRevoke.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'OfferRevoke';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - OfferRevoke';  -- FIXED -- do not change
