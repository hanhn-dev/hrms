/* =============================================================================
   Remove the TEST workflow created by recruitment/IJPApproval.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'IJP Approval';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - IJP Approval';  -- FIXED -- do not change
