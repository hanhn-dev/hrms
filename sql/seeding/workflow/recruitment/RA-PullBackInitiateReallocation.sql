/* =============================================================================
   Create a test workflow for the Recruitment module's
   RA-PullBackInitiateReallocation page
   ...
   Pullback counterpart to RA-InitiateReallocation.sql.
   ...
   To remove what this script created, see ./RA-PullBackInitiateReallocation.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'RA-PullBackInitiateReallocation';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - RA-PullBackInitiateReallocation';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run RA-PullBackInitiateReallocation.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
