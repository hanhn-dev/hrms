/* =============================================================================
   Create a test workflow for the Recruitment module's OfferRevoke page
   ...
   Offer revoke approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./OfferRevoke.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'OfferRevoke';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - OfferRevoke';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run OfferRevoke.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
