/* =============================================================================
   Remove the TEST workflow created by recruitment/RecruitmentManagement.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RecruitmentManagement';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - RecruitmentManagement';  -- FIXED -- do not change
