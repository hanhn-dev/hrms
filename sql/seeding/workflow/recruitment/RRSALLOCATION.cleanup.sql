/* =============================================================================
   Remove the TEST workflow created by recruitment/RRSALLOCATION.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RRSALLOCATION';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - RRSALLOCATION';  -- FIXED -- do not change
