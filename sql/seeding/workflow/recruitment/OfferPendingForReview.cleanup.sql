/* =============================================================================
   Remove the TEST workflow created by recruitment/OfferPendingForReview.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'OfferPendingForReview';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - OfferPendingForReview';  -- FIXED -- do not change
