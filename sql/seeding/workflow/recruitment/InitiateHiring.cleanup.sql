/* =============================================================================
   Remove the TEST workflow created by recruitment/InitiateHiring.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'InitiateHiring';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - InitiateHiring';  -- FIXED -- do not change
