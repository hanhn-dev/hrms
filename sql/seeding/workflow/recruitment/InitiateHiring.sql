/* =============================================================================
   Create a test workflow for the Recruitment module's InitiateHiring page
   ...
   To remove what this script created, see ./InitiateHiring.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'InitiateHiring';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - InitiateHiring';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run InitiateHiring.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
