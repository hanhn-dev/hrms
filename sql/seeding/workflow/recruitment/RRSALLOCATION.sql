/* =============================================================================
   Create a test workflow for the Recruitment module's RRSALLOCATION page
   ...
   RRS allocation page (uppercase literal).
   ...
   To remove what this script created, see ./RRSALLOCATION.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'RRSALLOCATION';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - RRSALLOCATION';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run RRSALLOCATION.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
