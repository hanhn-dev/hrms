/* =============================================================================
   Create a test workflow for the Recruitment module's DocumentBuilderRecruitment page
   ...
   Recruitment document builder approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./DocumentBuilderRecruitment.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'DocumentBuilderRecruitment';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Recruitment - DocumentBuilderRecruitment';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run DocumentBuilderRecruitment.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
