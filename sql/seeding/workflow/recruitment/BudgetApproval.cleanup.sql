/* =============================================================================
   Remove the TEST workflow created by recruitment/BudgetApproval.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'BudgetApproval';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Recruitment - BudgetApproval';  -- FIXED -- do not change
