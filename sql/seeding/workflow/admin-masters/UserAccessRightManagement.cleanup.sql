/* =============================================================================
   Remove the TEST workflow created by admin-masters/UserAccessRightManagement.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'UserAccessRightManagement';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - UserAccessRightManagement';  -- FIXED -- do not change
