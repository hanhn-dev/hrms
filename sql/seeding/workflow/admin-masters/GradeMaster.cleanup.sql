/* =============================================================================
   Remove the TEST workflow created by admin-masters/GradeMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'GradeMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - GradeMaster';  -- FIXED -- do not change
