/* =============================================================================
   Remove the TEST workflow created by admin-masters/NewsAndEvents.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'NewsAndEvents';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - NewsAndEvents';  -- FIXED -- do not change
