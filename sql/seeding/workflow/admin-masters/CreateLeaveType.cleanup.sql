/* =============================================================================
   Remove the TEST workflow created by admin-masters/CreateLeaveType.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'CreateLeaveType';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Masters - CreateLeaveType';  -- FIXED -- do not change
