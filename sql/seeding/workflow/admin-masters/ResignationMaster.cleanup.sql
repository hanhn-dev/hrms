/* =============================================================================
   Remove the TEST workflow created by admin-masters/ResignationMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ResignationMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - ResignationMaster';  -- FIXED -- do not change
