/* =============================================================================
   Create a test workflow for the Admin Masters module's SetDesignations page
   ...
   To remove what this script created, see ./SetDesignations.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'SetDesignations';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Masters - SetDesignations';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run SetDesignations.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
