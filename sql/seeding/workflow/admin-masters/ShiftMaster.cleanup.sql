/* =============================================================================
   Remove the TEST workflow created by admin-masters/ShiftMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ShiftMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - ShiftMaster';  -- FIXED -- do not change
