/* =============================================================================
   Remove the TEST workflow created by admin-masters/PolicyDocumentsSetup.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'Policy Documents Setup';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - Policy Documents Setup';  -- FIXED -- do not change
