/* =============================================================================
   Remove the TEST workflow created by admin-masters/SetDesignations.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'SetDesignations';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Masters - SetDesignations';  -- FIXED -- do not change
