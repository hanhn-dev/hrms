/* =============================================================================
   ...
   RoleAccessRightManagement page
   ...
   Role/access rights master page.
   ...
   To remove what this script created, see ./RoleAccessRightManagement.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'RoleAccessRightManagement';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Masters - RoleAccessRightManagement';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run RoleAccessRightManagement.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
