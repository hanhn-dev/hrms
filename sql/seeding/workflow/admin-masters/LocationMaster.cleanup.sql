/* =============================================================================
   Remove the TEST workflow created by admin-masters/LocationMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'LocationMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - LocationMaster';  -- FIXED -- do not change
