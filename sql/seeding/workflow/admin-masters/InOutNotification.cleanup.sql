/* =============================================================================
   Remove the TEST workflow created by admin-masters/InOutNotification.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'InOutNotification';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - InOutNotification';  -- FIXED -- do not change
