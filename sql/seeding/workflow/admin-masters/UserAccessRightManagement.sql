/* =============================================================================
   Create a test workflow for the Admin Configuration module's UserAccessRightManagement page
   ...
   User access right management approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./UserAccessRightManagement.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'UserAccessRightManagement';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Configuration - UserAccessRightManagement';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run UserAccessRightManagement.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
