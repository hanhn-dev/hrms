/* =============================================================================
   Remove the TEST workflow created by admin-masters/WeeklyOffMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'WeeklyOffMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - WeeklyOffMaster';  -- FIXED -- do not change
