/* =============================================================================
   Create a test workflow for the Admin Configuration module's OptionalHolidayMaster page
   ...
   Optional holiday master change approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./OptionalHolidayMaster.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'OptionalHolidayMaster';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Configuration - OptionalHolidayMaster';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run OptionalHolidayMaster.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
