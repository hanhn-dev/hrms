/* =============================================================================
   Remove the TEST workflow created by admin-masters/BankMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'BankMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Masters - BankMaster';  -- FIXED -- do not change
