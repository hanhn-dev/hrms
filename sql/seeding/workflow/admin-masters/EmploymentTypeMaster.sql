/* =============================================================================
   Create a test workflow for the Admin Configuration module's EmploymentTypeMaster page
   ...
   Employment type master change approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./EmploymentTypeMaster.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'EmploymentTypeMaster';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Configuration - EmploymentTypeMaster';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run EmploymentTypeMaster.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
