/* =============================================================================
   Remove the TEST workflow created by admin-masters/EmploymentTypeMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EmploymentTypeMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - EmploymentTypeMaster';  -- FIXED -- do not change
