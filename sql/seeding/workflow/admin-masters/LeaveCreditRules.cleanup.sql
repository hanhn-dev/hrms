/* =============================================================================
   Remove the TEST workflow created by admin-masters/LeaveCreditRules.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'LeaveCreditRules';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - LeaveCreditRules';  -- FIXED -- do not change
