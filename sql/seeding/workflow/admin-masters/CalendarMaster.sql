/* =============================================================================
   Create a test workflow for the Admin Masters module's CalendarMaster page
   ...
   To remove what this script created, see ./CalendarMaster.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'CalendarMaster';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Masters - CalendarMaster';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run CalendarMaster.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
