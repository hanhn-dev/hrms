/* =============================================================================
   Create a test workflow for the Admin Masters module's
   BackgroundVerificationCategory page
   ...
   To remove what this script created, see ./BackgroundVerificationCategory.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'BackgroundVerificationCategory';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Masters - BackgroundVerificationCategory';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run BackgroundVerificationCategory.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
