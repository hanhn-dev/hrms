/* =============================================================================
   Remove the TEST workflow created by admin-masters/SkillCategories.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'SkillCategories';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Masters - SkillCategories';  -- FIXED -- do not change
