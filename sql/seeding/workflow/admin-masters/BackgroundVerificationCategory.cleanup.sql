/* =============================================================================
   Remove the TEST workflow created by admin-masters/BackgroundVerificationCategory.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'BackgroundVerificationCategory';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Masters - BackgroundVerificationCategory';  -- FIXED -- do not change
