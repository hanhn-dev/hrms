/* =============================================================================
   Create a test workflow for the Admin Masters module's CreateLeaveType page
   ...
   Leave type creation (admin config change) page.
   ...
   To remove what this script created, see ./CreateLeaveType.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'CreateLeaveType';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Masters - CreateLeaveType';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run CreateLeaveType.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
