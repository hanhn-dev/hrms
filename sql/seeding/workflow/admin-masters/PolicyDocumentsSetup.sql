/* =============================================================================
   Create a test workflow for the Admin Configuration module's Policy Documents Setup page
   ...
   Policy documents setup change approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./PolicyDocumentsSetup.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'Policy Documents Setup';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Configuration - Policy Documents Setup';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run PolicyDocumentsSetup.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
