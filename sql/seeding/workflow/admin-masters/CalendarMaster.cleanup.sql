/* =============================================================================
   Remove the TEST workflow created by admin-masters/CalendarMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'CalendarMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Masters - CalendarMaster';  -- FIXED -- do not change
