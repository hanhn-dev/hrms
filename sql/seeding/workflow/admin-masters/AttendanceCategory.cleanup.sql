/* =============================================================================
   Remove the TEST workflow created by admin-masters/AttendanceCategory.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'AttendanceCategory';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - AttendanceCategory';  -- FIXED -- do not change
