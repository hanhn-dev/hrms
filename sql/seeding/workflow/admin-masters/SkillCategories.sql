/* =============================================================================
   Create a test workflow for the Admin Masters module's SkillCategories page
   ...
   To remove what this script created, see ./SkillCategories.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'SkillCategories';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Admin Masters - SkillCategories';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run SkillCategories.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
