/* =============================================================================
   Remove the TEST workflow created by admin-masters/WorkflowGroup.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'WorkflowGroup';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - WorkflowGroup';  -- FIXED -- do not change
