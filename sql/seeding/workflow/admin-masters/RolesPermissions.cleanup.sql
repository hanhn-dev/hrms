/* =============================================================================
   Remove the TEST workflow created by admin-masters/RolesPermissions.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RolesPermissions';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - RolesPermissions';  -- FIXED -- do not change
