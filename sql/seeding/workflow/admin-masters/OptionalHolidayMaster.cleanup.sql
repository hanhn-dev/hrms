/* =============================================================================
   Remove the TEST workflow created by admin-masters/OptionalHolidayMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'OptionalHolidayMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - OptionalHolidayMaster';  -- FIXED -- do not change
