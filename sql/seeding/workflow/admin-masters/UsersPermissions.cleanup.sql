/* =============================================================================
   Remove the TEST workflow created by admin-masters/UsersPermissions.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'UsersPermissions';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - UsersPermissions';  -- FIXED -- do not change
