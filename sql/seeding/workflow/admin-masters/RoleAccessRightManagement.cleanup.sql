/* =============================================================================
   Remove the TEST workflow created by admin-masters/RoleAccessRightManagement.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RoleAccessRightManagement';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Masters - RoleAccessRightManagement';  -- FIXED -- do not change
