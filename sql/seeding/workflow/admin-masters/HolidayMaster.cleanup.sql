/* =============================================================================
   Remove the TEST workflow created by admin-masters/HolidayMaster.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'HolidayMaster';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Admin Configuration - HolidayMaster';  -- FIXED -- do not change
