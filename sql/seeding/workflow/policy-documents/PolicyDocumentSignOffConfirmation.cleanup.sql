/* =============================================================================
   Remove the TEST workflow created by policy-documents/PolicyDocumentSignOffConfirmation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'PolicyDocumentSignOffConfirmation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Policy Documents - PolicyDocumentSignOffConfirmation';  -- FIXED -- do not change
