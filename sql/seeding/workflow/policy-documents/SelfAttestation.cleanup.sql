/* =============================================================================
   Remove the TEST workflow created by policy-documents/SelfAttestation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'SelfAttestation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Policy Documents - SelfAttestation';  -- FIXED -- do not change
