/* =============================================================================
   Remove the TEST workflow created by policy-documents/PolicyDocumentActivation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'PolicyDocumentActivation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Policy Documents - PolicyDocumentActivation';  -- FIXED -- do not change
