/* =============================================================================
   Remove the TEST workflow created by reward-and-recognition/EmployeeRecognition.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EmployeeRecognition';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Reward & Recognition - EmployeeRecognition';  -- FIXED -- do not change
