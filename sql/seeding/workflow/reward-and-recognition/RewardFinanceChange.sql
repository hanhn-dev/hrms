/* =============================================================================
   Create a test workflow for the Reward & Recognition module's RewardFinanceChange page
   ...
   Reward finance config change approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./RewardFinanceChange.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'RewardFinanceChange';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Reward & Recognition - RewardFinanceChange';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run RewardFinanceChange.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
