/* =============================================================================
   Remove the TEST workflow created by reward-and-recognition/RecognitionAward.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RecognitionAward';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Reward & Recognition - RecognitionAward';  -- FIXED -- do not change
