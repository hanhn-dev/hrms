/* =============================================================================
   Remove the TEST workflow created by reward-and-recognition/JuryAward.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'JuryAward';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Reward & Recognition - JuryAward';  -- FIXED -- do not change
