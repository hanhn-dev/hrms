/* =============================================================================
   Remove the TEST workflow created by reward-and-recognition/SpotlightAward.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'SpotlightAward';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Reward & Recognition - SpotlightAward';  -- FIXED -- do not change
