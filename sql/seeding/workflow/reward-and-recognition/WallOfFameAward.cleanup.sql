/* =============================================================================
   Remove the TEST workflow created by reward-and-recognition/WallOfFameAward.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'WallOfFameAward';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Reward & Recognition - WallOfFameAward';  -- FIXED -- do not change
