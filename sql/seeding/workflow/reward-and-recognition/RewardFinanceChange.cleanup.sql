/* =============================================================================
   Remove the TEST workflow created by reward-and-recognition/RewardFinanceChange.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RewardFinanceChange';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Reward & Recognition - RewardFinanceChange';  -- FIXED -- do not change
