/* =============================================================================
   Create a test workflow for the Reward & Recognition module's RecognitionAward page
   ...
   Recognition award template approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./RecognitionAward.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'RecognitionAward';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Reward & Recognition - RecognitionAward';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run RecognitionAward.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
