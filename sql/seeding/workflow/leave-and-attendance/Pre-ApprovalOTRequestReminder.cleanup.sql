/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/Pre-ApprovalOTRequestReminder.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'Pre-ApprovalOTRequestReminder';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - Pre-ApprovalOTRequestReminder';  -- FIXED -- do not change
