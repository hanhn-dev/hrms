/* =============================================================================
   Create a test workflow for the Leave & Attendance module's WFHCancellation
   page
   ...
   OFF, WFH cancellation instead routes through 'AttendanceRegularize-WFH' -- see
   ...
   To remove what this script created, see ./WFHCancellation.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'WFHCancellation';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - WFHCancellation';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run WFHCancellation.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
