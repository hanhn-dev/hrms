/* =============================================================================
   Create a test workflow for the Leave & Attendance module's ClaimOverTime page
   ...
   Originally seeded as 'AttendanceOverTime', later renamed to 'ClaimOverTime';
   IsWorkflowAvailable = 1 confirmed.
   ...
   To remove what this script created, see ./ClaimOverTime.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ClaimOverTime';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - ClaimOverTime';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ClaimOverTime.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
