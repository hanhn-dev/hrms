/* =============================================================================
   Create a test workflow for the Leave & Attendance module's OnDutyCancellation
   page
   ...
   OFF, On-Duty cancellation instead routes through 'OnDuty' -- see
   ...
   To remove what this script created, see ./OnDutyCancellation.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'OnDutyCancellation';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - OnDutyCancellation';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run OnDutyCancellation.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
