/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/ClaimOverTime.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ClaimOverTime';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - ClaimOverTime';  -- FIXED -- do not change
