/* =============================================================================
   Create a test workflow for the Leave & Attendance module's AttendanceRegularize-WFH page
   ...
   Attendance regularize / WFH remapped page (live ModulePageName). Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./AttendanceRegularize-WFH.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'AttendanceRegularize-WFH';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - AttendanceRegularize-WFH';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run AttendanceRegularize-WFH.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
