/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/ClaimCompOff.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ClaimCompOff';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - ClaimCompOff';  -- FIXED -- do not change
