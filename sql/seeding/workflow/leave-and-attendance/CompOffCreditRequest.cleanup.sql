/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/CompOffCreditRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'CompOffCreditRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - CompOffCreditRequest';  -- FIXED -- do not change
