/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/AttendanceNotification.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'AttendanceNotification';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - AttendanceNotification';  -- FIXED -- do not change
