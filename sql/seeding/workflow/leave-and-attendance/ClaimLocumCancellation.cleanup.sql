/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/ClaimLocumCancellation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ClaimLocumCancellation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - ClaimLocumCancellation';  -- FIXED -- do not change
