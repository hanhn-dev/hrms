/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/LeaveCancellation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'LeaveCancellation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - LeaveCancellation';  -- FIXED -- do not change
