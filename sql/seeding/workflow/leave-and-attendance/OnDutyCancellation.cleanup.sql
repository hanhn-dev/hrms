/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/OnDutyCancellation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'OnDutyCancellation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - OnDutyCancellation';  -- FIXED -- do not change
