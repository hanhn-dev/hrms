/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/ClaimPHRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ClaimPHRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - ClaimPHRequest';  -- FIXED -- do not change
