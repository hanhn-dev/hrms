/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/AttendanceRegularize.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'AttendanceRegularize';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - AttendanceRegularize';  -- FIXED -- do not change
