/* =============================================================================
   Create a test workflow for the Leave & Attendance module's Pre-ApprovalOTRequestReminder page
   ...
   Pre-approval OT request reminder workflow. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./Pre-ApprovalOTRequestReminder.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'Pre-ApprovalOTRequestReminder';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - Pre-ApprovalOTRequestReminder';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run Pre-ApprovalOTRequestReminder.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
