/* =============================================================================
   Create a test workflow for the Leave & Attendance module's ARCancellation page
   ...
   OFF, AR cancellation instead routes through 'AttendanceRegularize' -- see
   ...
   To remove what this script created, see ./ARCancellation.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ARCancellation';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - ARCancellation';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ARCancellation.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
