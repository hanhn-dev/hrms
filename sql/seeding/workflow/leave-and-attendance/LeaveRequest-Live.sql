/* =============================================================================
   Create a test workflow for the Leave & Attendance module's LeaveRequest page
   ...
   Leave request using the live mixed-case ModulePageName (employer 10). Distinct from LEAVEREQUEST.sql because Windows FS is case-insensitive.
...
DECLARE @ModulePageName   VARCHAR(200)  = 'LeaveRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - LeaveRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run LeaveRequest-Live.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
