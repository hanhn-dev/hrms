/* =============================================================================
   Create a test workflow for the Leave & Attendance module's RequestReroute page
   ...
   Generic request reroute/reassign page used cross-domain, but confirmed module
   = Leave & Attendance.
   ...
   To remove what this script created, see ./RequestReroute.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'RequestReroute';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - RequestReroute';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run RequestReroute.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
