/* =============================================================================
   Create a test workflow for the Leave & Attendance module's OnDuty page
   ...
   Base On-Duty request page; see OnDutyCancellation.sql for the related
   cancellation flow.
   ...
   To remove what this script created, see ./OnDuty.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'OnDuty';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - OnDuty';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run OnDuty.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
