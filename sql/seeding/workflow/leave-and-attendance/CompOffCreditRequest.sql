/* =============================================================================
   Create a test workflow for the Leave & Attendance module's CompOffCreditRequest page
   ...
   Comp-off credit request approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./CompOffCreditRequest.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'CompOffCreditRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - CompOffCreditRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run CompOffCreditRequest.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
