/* =============================================================================
   ...
   Most-verified page in pagetitle-reference.md -- good starting point for a
   smoke test.
   ...
   To remove what this script created, see ./LEAVEREQUEST.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run LEAVEREQUEST.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
