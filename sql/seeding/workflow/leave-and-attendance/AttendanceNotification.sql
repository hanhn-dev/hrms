/* =============================================================================
   Create a test workflow for the Leave & Attendance module's AttendanceNotification page
   ...
   Attendance notification workflow. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./AttendanceNotification.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'AttendanceNotification';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - AttendanceNotification';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run AttendanceNotification.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
