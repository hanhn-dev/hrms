/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/LeaveRequest-Live.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'LeaveRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - LeaveRequest';  -- FIXED -- do not change
