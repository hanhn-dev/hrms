/* =============================================================================
   Create a test workflow for the Leave & Attendance module's LeaveEncashment
   page
   ...
   To remove what this script created, see ./LeaveEncashment.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'LeaveEncashment';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - LeaveEncashment';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run LeaveEncashment.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
