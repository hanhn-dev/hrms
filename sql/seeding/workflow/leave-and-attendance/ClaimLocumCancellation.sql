/* =============================================================================
   ...
   IsWorkflowAvailable = 1 confirmed; paired request page is
   ClaimLocumRequest.sql.
   ...
   To remove what this script created, see ./ClaimLocumCancellation.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ClaimLocumCancellation';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - ClaimLocumCancellation';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ClaimLocumCancellation.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
