/* =============================================================================
   ...
   Base Attendance Regularization request page; see ARCancellation.sql for the
   related cancellation flow.
   ...
   To remove what this script created, see ./AttendanceRegularize.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'AttendanceRegularize';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - AttendanceRegularize';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run AttendanceRegularize.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
