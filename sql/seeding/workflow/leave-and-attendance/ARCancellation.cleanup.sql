/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/ARCancellation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ARCancellation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - ARCancellation';  -- FIXED -- do not change
