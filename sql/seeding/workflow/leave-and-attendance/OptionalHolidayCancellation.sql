/* =============================================================================
   Create a test workflow for the Leave & Attendance module's
   OptionalHolidayCancellation page
   ...
   This is the page used when the employer's pullback-workflow flag is ON; when
   OFF, Optional Holiday cancellation instead routes through
   'OptionalHolidayRequest' -- see pagetitle-reference.md.
   ...
   To remove what this script created, see ./OptionalHolidayCancellation.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'OptionalHolidayCancellation';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - OptionalHolidayCancellation';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run OptionalHolidayCancellation.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
