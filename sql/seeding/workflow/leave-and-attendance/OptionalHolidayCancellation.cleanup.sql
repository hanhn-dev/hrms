/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/OptionalHolidayCancellation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'OptionalHolidayCancellation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - OptionalHolidayCancellation';  -- FIXED -- do not change
