/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/WFHCancellation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'WFHCancellation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - WFHCancellation';  -- FIXED -- do not change
