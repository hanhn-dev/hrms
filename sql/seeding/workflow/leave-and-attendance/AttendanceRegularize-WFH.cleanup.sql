/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/AttendanceRegularize-WFH.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'AttendanceRegularize-WFH';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - AttendanceRegularize-WFH';  -- FIXED -- do not change
