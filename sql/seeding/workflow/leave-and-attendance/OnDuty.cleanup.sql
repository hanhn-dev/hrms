/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/OnDuty.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'OnDuty';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - OnDuty';  -- FIXED -- do not change
