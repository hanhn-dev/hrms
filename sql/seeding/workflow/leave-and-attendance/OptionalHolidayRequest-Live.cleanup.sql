/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/OptionalHolidayRequest-Live.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'OptionalHolidayRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - OptionalHolidayRequest';  -- FIXED -- do not change
