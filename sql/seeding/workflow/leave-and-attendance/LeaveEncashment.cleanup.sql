/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/LeaveEncashment.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'LeaveEncashment';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - LeaveEncashment';  -- FIXED -- do not change
