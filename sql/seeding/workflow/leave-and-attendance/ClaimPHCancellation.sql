/* =============================================================================
   Create a test workflow for the Leave & Attendance module's ClaimPHCancellation
   page
   ...
   Paired request page is ClaimPHRequest.sql; see its note on the older 'ClaimPH'
   alias.
   ...
   To remove what this script created, see ./ClaimPHCancellation.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ClaimPHCancellation';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - ClaimPHCancellation';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ClaimPHCancellation.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
