/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/CompOffRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'CompOffRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - CompOffRequest';  -- FIXED -- do not change
