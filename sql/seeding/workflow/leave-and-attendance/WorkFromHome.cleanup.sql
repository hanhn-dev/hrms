/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/WorkFromHome.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'WorkFromHome';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - WorkFromHome';  -- FIXED -- do not change
