/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/ClaimLocumRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ClaimLocumRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - ClaimLocumRequest';  -- FIXED -- do not change
