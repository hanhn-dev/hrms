/* =============================================================================
   ...
   Base Optional Holiday request page (uppercase literal, like LEAVEREQUEST).
   ...
   To remove what this script created, see ./OPTIONALHOLIDAYREQUEST.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run OPTIONALHOLIDAYREQUEST.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
