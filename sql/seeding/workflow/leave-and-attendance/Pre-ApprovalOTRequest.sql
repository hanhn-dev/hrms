/* =============================================================================
   ...
   To remove what this script created, see ./Pre-ApprovalOTRequest.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'Pre-ApprovalOTRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - Pre-ApprovalOTRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run Pre-ApprovalOTRequest.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
