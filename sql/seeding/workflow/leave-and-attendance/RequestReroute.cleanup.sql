/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/RequestReroute.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RequestReroute';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - RequestReroute';  -- FIXED -- do not change
