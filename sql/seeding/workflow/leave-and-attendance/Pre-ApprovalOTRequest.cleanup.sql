/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/Pre-ApprovalOTRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'Pre-ApprovalOTRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - Pre-ApprovalOTRequest';  -- FIXED -- do not change
