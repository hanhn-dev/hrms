/* =============================================================================
   Create a test workflow for the Leave & Attendance module's ClaimLocumRequest
   page
   ...
   IsWorkflowAvailable = 1 confirmed; paired cancellation page is
   ClaimLocumCancellation.sql.
   ...
   To remove what this script created, see ./ClaimLocumRequest.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ClaimLocumRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Leave & Attendance - ClaimLocumRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ClaimLocumRequest.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
