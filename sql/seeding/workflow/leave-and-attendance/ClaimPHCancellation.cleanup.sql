/* =============================================================================
   Remove the TEST workflow created by leave-and-attendance/ClaimPHCancellation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ClaimPHCancellation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Leave & Attendance - ClaimPHCancellation';  -- FIXED -- do not change
