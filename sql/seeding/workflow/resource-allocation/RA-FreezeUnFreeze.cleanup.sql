/* =============================================================================
   Remove the TEST workflow created by resource-allocation/RA-FreezeUnFreeze.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'RA-FreezeUnFreeze';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Resource Allocation - RA-FreezeUnFreeze';  -- FIXED -- do not change
