/* =============================================================================
   Create a test workflow for the Resource Allocation module's RA-FreezeUnFreeze page
   ...
   Resource allocation freeze/unfreeze approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./RA-FreezeUnFreeze.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'RA-FreezeUnFreeze';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Resource Allocation - RA-FreezeUnFreeze';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run RA-FreezeUnFreeze.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
