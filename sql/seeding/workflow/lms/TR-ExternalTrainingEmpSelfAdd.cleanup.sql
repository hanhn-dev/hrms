/* =============================================================================
   Remove the TEST workflow created by lms/TR-ExternalTrainingEmpSelfAdd.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TR-ExternalTrainingEmpSelfAdd';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - LMS - TR-ExternalTrainingEmpSelfAdd';  -- FIXED -- do not change
