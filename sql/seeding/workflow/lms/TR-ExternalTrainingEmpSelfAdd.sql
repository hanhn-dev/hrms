/* =============================================================================
   Create a test workflow for the LMS module's TR-ExternalTrainingEmpSelfAdd page
   ...
   External training added by employee approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./TR-ExternalTrainingEmpSelfAdd.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TR-ExternalTrainingEmpSelfAdd';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - LMS - TR-ExternalTrainingEmpSelfAdd';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TR-ExternalTrainingEmpSelfAdd.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
