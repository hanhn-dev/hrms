/* =============================================================================
   Create a test workflow for the Separation module's SeparationRequestReroute
   page
   ...
   Separation-specific request reroute page (distinct from the Leave & Attendance
   module's generic RequestReroute.sql).
   ...
   To remove what this script created, see ./SeparationRequestReroute.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'SeparationRequestReroute';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Separation - SeparationRequestReroute';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run SeparationRequestReroute.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
