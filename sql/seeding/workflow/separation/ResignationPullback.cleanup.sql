/* =============================================================================
   Remove the TEST workflow created by separation/ResignationPullback.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ResignationPullback';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Separation - ResignationPullback';  -- FIXED -- do not change
