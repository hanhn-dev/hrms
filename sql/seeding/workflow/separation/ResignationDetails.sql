/* =============================================================================
   Create a test workflow for the Separation module's ResignationDetails page
   ...
   To remove what this script created, see ./ResignationDetails.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ResignationDetails';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Separation - ResignationDetails';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ResignationDetails.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
