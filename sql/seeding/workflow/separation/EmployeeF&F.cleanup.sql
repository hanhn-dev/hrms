/* =============================================================================
   Remove the TEST workflow created by separation/EmployeeF&F.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EmployeeF&F';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Separation - EmployeeF&F';  -- FIXED -- do not change
