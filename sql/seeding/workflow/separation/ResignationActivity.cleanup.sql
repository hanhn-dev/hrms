/* =============================================================================
   Remove the TEST workflow created by separation/ResignationActivity.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ResignationActivity';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Separation - ResignationActivity';  -- FIXED -- do not change
