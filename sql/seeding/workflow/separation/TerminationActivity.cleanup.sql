/* =============================================================================
   Remove the TEST workflow created by separation/TerminationActivity.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'TerminationActivity';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Separation - TerminationActivity';  -- FIXED -- do not change
