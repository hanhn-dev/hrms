/* =============================================================================
   Create a test workflow for the Separation module's ResignationActivity page
   ...
   To remove what this script created, see ./ResignationActivity.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ResignationActivity';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Separation - ResignationActivity';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ResignationActivity.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
