/* =============================================================================
   Create a test workflow for the Separation module's ResignationPullback page
   ...
   To remove what this script created, see ./ResignationPullback.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ResignationPullback';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Separation - ResignationPullback';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ResignationPullback.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
