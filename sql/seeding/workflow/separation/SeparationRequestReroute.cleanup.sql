/* =============================================================================
   Remove the TEST workflow created by separation/SeparationRequestReroute.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'SeparationRequestReroute';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Separation - SeparationRequestReroute';  -- FIXED -- do not change
