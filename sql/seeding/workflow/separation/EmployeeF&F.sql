/* =============================================================================
   Create a test workflow for the Separation module's EmployeeF&F page
   ...
   Full & Final Settlement page; IsWorkflowAvailable = 1 confirmed.
   ...
   To remove what this script created, see ./EmployeeF&F.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'EmployeeF&F';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Separation - EmployeeF&F';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run EmployeeF&F.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
