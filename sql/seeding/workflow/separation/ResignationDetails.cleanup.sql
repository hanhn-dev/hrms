/* =============================================================================
   Remove the TEST workflow created by separation/ResignationDetails.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ResignationDetails';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Separation - ResignationDetails';  -- FIXED -- do not change
