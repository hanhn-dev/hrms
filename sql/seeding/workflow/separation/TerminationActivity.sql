/* =============================================================================
   Create a test workflow for the Separation module's TerminationActivity page
   ...
   To remove what this script created, see ./TerminationActivity.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'TerminationActivity';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Separation - TerminationActivity';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run TerminationActivity.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
