/* =============================================================================
   Remove the TEST workflow created by my-details/MyDetails.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'MyDetails';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - My Details - MyDetails';  -- FIXED -- do not change
