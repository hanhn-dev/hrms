/* =============================================================================
   Create a test workflow for the My Details module's EndOfContractReminder page
   ...
   MyDetails.aspx. Reminder notification ahead of an employee's contract end date.
   ...
   To remove what this script created, see ./EndOfContractReminder.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'EndOfContractReminder';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - My Details - EndOfContractReminder';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run EndOfContractReminder.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
