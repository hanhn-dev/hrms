/* =============================================================================
   Create a test workflow for the My Details module's MyDetails page
   ...
   My Details page workflow. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./MyDetails.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'MyDetails';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - My Details - MyDetails';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run MyDetails.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
