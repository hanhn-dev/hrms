/* =============================================================================
   Remove the TEST workflow created by my-details/EmployeeLetters.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EmployeeLetters';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - My Details - EmployeeLetters';  -- FIXED -- do not change
