/* =============================================================================
   Remove the TEST workflow created by my-details/EndOfContractReminder.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EndOfContractReminder';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - My Details - EndOfContractReminder';  -- FIXED -- do not change
