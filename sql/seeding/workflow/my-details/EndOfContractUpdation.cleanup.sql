/* =============================================================================
   Remove the TEST workflow created by my-details/EndOfContractUpdation.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EndOfContractUpdation';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - My Details - EndOfContractUpdation';  -- FIXED -- do not change
