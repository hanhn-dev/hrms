/* =============================================================================
   Remove the TEST workflow created by my-details/EmploymentTypeChange.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EmploymentTypeChange';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - My Details - EmploymentTypeChange';  -- FIXED -- do not change
