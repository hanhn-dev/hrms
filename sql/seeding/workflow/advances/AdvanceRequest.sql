/* =============================================================================
   Create a test workflow for the Advances module's AdvanceRequest page
   ...
   Advance request approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./AdvanceRequest.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'AdvanceRequest';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Advances - AdvanceRequest';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run AdvanceRequest.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
