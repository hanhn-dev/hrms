/* =============================================================================
   Remove the TEST workflow created by advances/AdvanceRequest.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'AdvanceRequest';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Advances - AdvanceRequest';  -- FIXED -- do not change
