/* =============================================================================
   Remove the TEST workflow created by asset-management/UpcomingAssetAllocationEndDate.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'UpcomingAssetAllocationEndDate';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Asset Management - UpcomingAssetAllocationEndDate';  -- FIXED -- do not change
