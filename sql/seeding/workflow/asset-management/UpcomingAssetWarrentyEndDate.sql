/* =============================================================================
   Create a test workflow for the Asset Management module's UpcomingAssetWarrentyEndDate page
   ...
   Upcoming asset warranty end-date notification workflow. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./UpcomingAssetWarrentyEndDate.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'UpcomingAssetWarrentyEndDate';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Asset Management - UpcomingAssetWarrentyEndDate';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run UpcomingAssetWarrentyEndDate.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
