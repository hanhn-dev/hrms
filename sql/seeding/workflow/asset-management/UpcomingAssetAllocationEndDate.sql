/* =============================================================================
   Create a test workflow for the Asset Management module's UpcomingAssetAllocationEndDate page
   ...
   Upcoming asset allocation end-date notification workflow. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./UpcomingAssetAllocationEndDate.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'UpcomingAssetAllocationEndDate';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Asset Management - UpcomingAssetAllocationEndDate';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run UpcomingAssetAllocationEndDate.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
