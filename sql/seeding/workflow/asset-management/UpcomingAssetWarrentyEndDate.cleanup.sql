/* =============================================================================
   Remove the TEST workflow created by asset-management/UpcomingAssetWarrentyEndDate.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'UpcomingAssetWarrentyEndDate';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Asset Management - UpcomingAssetWarrentyEndDate';  -- FIXED -- do not change
