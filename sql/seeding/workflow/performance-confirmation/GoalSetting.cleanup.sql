/* =============================================================================
   Remove the TEST workflow created by performance-confirmation/GoalSetting.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'GoalSetting';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Performance & Confirmation - GoalSetting';  -- FIXED -- do not change
