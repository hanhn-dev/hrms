/* =============================================================================
   Remove the TEST workflow created by performance-confirmation/SelfAssessment.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'SelfAssessment';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Performance & Confirmation - SelfAssessment';  -- FIXED -- do not change
