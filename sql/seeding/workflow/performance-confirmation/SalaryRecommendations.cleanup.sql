/* =============================================================================
   Remove the TEST workflow created by performance-confirmation/SalaryRecommendations.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'SalaryRecommendations';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Performance Assessment - SalaryRecommendations';  -- FIXED -- do not change
