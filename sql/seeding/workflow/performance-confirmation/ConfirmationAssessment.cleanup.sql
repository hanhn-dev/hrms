/* =============================================================================
   Remove the TEST workflow created by performance-confirmation/ConfirmationAssessment.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ConfirmationAssessment';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Performance & Confirmation - ConfirmationAssessment';  -- FIXED -- do not change
