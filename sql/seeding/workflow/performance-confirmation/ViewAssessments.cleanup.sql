/* =============================================================================
   Remove the TEST workflow created by performance-confirmation/ViewAssessments.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ViewAssessments';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Performance Assessment - ViewAssessments';  -- FIXED -- do not change
