/* =============================================================================
   Create a test workflow for the Employee Management module's ReactivationEmployeeDialog page
   ...
   Employee reactivation dialog approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./ReactivationEmployeeDialog.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ReactivationEmployeeDialog';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Employee Management - ReactivationEmployeeDialog';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ReactivationEmployeeDialog.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
