/* =============================================================================
   Remove the TEST workflow created by employee-management/EmployeeSummaryPermissions.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EmployeeSummaryPermissions';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Management - EmployeeSummaryPermissions';  -- FIXED -- do not change
