/* =============================================================================
   Create a test workflow for the Employee Management module's EmployeeDetails page
   ...
   Employee details change approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./EmployeeDetails.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'EmployeeDetails';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Employee Management - EmployeeDetails';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run EmployeeDetails.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
