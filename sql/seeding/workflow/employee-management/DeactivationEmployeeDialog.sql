/* =============================================================================
   Create a test workflow for the Employee Management module's DeactivationEmployeeDialog page
   ...
   Employee deactivation dialog approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./DeactivationEmployeeDialog.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'DeactivationEmployeeDialog';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Employee Management - DeactivationEmployeeDialog';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run DeactivationEmployeeDialog.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
