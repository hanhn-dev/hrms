/* =============================================================================
   Remove the TEST workflow created by employee-management/EmployeeDetails.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'EmployeeDetails';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Management - EmployeeDetails';  -- FIXED -- do not change
