/* =============================================================================
   Remove the TEST workflow created by employee-management/ReactivationEmployeeDialog.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ReactivationEmployeeDialog';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Management - ReactivationEmployeeDialog';  -- FIXED -- do not change
