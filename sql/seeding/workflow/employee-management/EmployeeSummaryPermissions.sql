/* =============================================================================
   Create a test workflow for the Employee Management module's EmployeeSummaryPermissions page
   ...
   Employee summary permissions change approval. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./EmployeeSummaryPermissions.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'EmployeeSummaryPermissions';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Employee Management - EmployeeSummaryPermissions';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run EmployeeSummaryPermissions.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
