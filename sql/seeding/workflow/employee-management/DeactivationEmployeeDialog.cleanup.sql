/* =============================================================================
   Remove the TEST workflow created by employee-management/DeactivationEmployeeDialog.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'DeactivationEmployeeDialog';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Management - DeactivationEmployeeDialog';  -- FIXED -- do not change
