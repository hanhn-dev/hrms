/* =============================================================================
   Remove the TEST workflow created by employee-self-service/DocumentBuilderESS.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'DocumentBuilderESS';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Self Service - DocumentBuilderESS';  -- FIXED -- do not change
