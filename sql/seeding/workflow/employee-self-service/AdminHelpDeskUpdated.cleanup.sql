/* =============================================================================
   Remove the TEST workflow created by employee-self-service/AdminHelpDeskUpdated.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'AdminHelpDeskUpdated';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Self Service - AdminHelpDeskUpdated';  -- FIXED -- do not change
