/* =============================================================================
   Remove the TEST workflow created by employee-self-service/ISHelpDeskSubmitted.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ISHelpDeskSubmitted';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Self Service - ISHelpDeskSubmitted';  -- FIXED -- do not change
