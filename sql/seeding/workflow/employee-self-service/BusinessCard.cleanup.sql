/* =============================================================================
   Remove the TEST workflow created by employee-self-service/BusinessCard.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'BusinessCard';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Self Service - BusinessCard';  -- FIXED -- do not change
