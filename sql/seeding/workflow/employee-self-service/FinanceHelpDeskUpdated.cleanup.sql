/* =============================================================================
   Remove the TEST workflow created by employee-self-service/FinanceHelpDeskUpdated.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'FinanceHelpDeskUpdated';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Self Service - FinanceHelpDeskUpdated';  -- FIXED -- do not change
