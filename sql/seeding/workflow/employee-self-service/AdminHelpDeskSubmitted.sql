/* =============================================================================
   Create a test workflow for the Employee Self Service module's AdminHelpDeskSubmitted page
   ...
   Admin help desk submitted request. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./AdminHelpDeskSubmitted.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'AdminHelpDeskSubmitted';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Employee Self Service - AdminHelpDeskSubmitted';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run AdminHelpDeskSubmitted.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
