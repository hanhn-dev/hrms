/* =============================================================================
   Remove the TEST workflow created by employee-self-service/ISHelpDeskUpdated.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'ISHelpDeskUpdated';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Self Service - ISHelpDeskUpdated';  -- FIXED -- do not change
