/* =============================================================================
   Remove the TEST workflow created by employee-self-service/AdminHelpDeskSubmitted.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'AdminHelpDeskSubmitted';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Self Service - AdminHelpDeskSubmitted';  -- FIXED -- do not change
