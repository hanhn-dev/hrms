/* =============================================================================
   Create a test workflow for the Employee Self Service module's FinanceHelpDeskSubmitted page
   ...
   Finance help desk submitted request. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./FinanceHelpDeskSubmitted.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'FinanceHelpDeskSubmitted';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Employee Self Service - FinanceHelpDeskSubmitted';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run FinanceHelpDeskSubmitted.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
