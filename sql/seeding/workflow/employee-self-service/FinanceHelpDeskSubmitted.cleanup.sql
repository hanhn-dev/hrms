/* =============================================================================
   Remove the TEST workflow created by employee-self-service/FinanceHelpDeskSubmitted.sql.
...
DECLARE @ModulePageName   VARCHAR(200) = 'FinanceHelpDeskSubmitted';  -- FIXED -- do not change
DECLARE @WorkflowName     VARCHAR(100) = 'TEST - Employee Self Service - FinanceHelpDeskSubmitted';  -- FIXED -- do not change
