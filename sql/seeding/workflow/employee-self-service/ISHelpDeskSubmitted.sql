/* =============================================================================
   Create a test workflow for the Employee Self Service module's ISHelpDeskSubmitted page
   ...
   IS help desk submitted request. Confirmed live for employer 10 via list-modules-and-pages.sql /
   ...
   To remove what this script created, see ./ISHelpDeskSubmitted.cleanup.sql (or ../cleanup-test-workflow.sql for WorkflowId / bulk).
   ========================================================================== */
SET NOCOUNT ON;
...
DECLARE @ModulePageName   VARCHAR(200)  = 'ISHelpDeskSubmitted';  -- FIXED for this script -- do not change
DECLARE @WorkflowName     VARCHAR(100)  = 'TEST - Employee Self Service - ISHelpDeskSubmitted';
...
IF @NewRoleName IS NOT NULL
    PRINT 'To remove this workflow, run ISHelpDeskSubmitted.cleanup.sql with @TargetEmployerId = ' + CAST(@TargetEmployerId AS VARCHAR(10))
