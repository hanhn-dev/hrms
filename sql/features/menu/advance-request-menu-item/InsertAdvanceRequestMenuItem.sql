DECLARE @MenuId INT;
DECLARE @MenuName VARCHAR(50) = 'Request Advances';
DECLARE @NavigateURL VARCHAR(50) = '/HRM/AdvanceModule/AdvanceRequests.aspx';
DECLARE @PageName VARCHAR(50) = 'AdvanceRequests.aspx';
DECLARE @EmployerId INT = 10;
DECLARE @Icon VARCHAR(50) = null;
DECLARE @ParentMenuId INT = 1157; -- Advances
...
<Tree AllowNodeEditing="True" EnableDragAndDrop="True" EnableDragAndDropBetweenNodes="True"
  OnClientContextMenuItemClicked="OnClientContextMenuItemClicked"
  FeatureGroupID="RadTreeViewDynamicMenu" EnableAjaxSkinRendering="False" RenderMode="Lightweight"
  Height="600px">
  <Node Text="Dynamic Menu" Value="1" Expanded="True">
    <Node Text="Home" Value="2" Expanded="True" />
    <Node Text="Admin Configuration" Value="3">
    ...
    <Node Text="Performance Assessment" Value="85" Expanded="True">
      ...
      <Node Text="PMS Dashboard" Value="602" />
    </Node>
    ...
    <Node Text="Advances" Value="1157">
      <Node Text="Request Advances" Value="1158" Expanded="True" />
    </Node>
    ...
    <Node Text="Task Management" Value="128" Expanded="True" Selected="True">
