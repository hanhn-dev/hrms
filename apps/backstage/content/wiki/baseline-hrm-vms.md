# HRM-VMS Database - Liquibase Baseline
...
This baseline represents the state of the HRM-VMS database as of **2026-02-06**. All 2 SQL files in the following directories have already been applied to production:
