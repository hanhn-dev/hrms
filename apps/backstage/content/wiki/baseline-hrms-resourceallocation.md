# HRMS-RESOURCEALLOCATION Database - Liquibase Baseline

**Baseline Date**: 2026-02-23
**Total SQL Files**: 194 files
**Status**: All files already applied to production

## What is This Baseline?

This baseline represents the state of the HRMS-RESOURCEALLOCATION database as of **2026-02-23**. All 194 SQL files in the following directories have already been applied to production:
...
```bash
cd HRMS-DATABASE/HRMS-RESOURCEALLOCATION
liquibase status
```
...
-- Should see one row:
-- ID: baseline-existing-db-2026-02-23
-- TAG: baseline-v1.0
```
