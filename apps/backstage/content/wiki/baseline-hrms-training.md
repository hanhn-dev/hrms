# HRMS-TRAINING Database - Liquibase Baseline

**Baseline Date**: 2026-02-23
**Total SQL Files**: 525 files
**Status**: All files already applied to production

## What is This Baseline?

This baseline represents the state of the HRMS-TRAINING database as of **2026-02-23**. All 525 SQL files in the following directories have already been applied to production:
...
```bash
cd HRMS-DATABASE/HRMS-TRAINING
liquibase status
```
