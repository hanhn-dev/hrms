# HRMS-RewardNRecognition Database - Liquibase Baseline

**Baseline Date**: 2026-02-06
**Total SQL Files**: 1 files
**Status**: All files already applied to production

## What is This Baseline?

This baseline represents the state of the HRMS-RewardNRecognition database as of **2026-02-06**. All 1 SQL files in the following directories have already been applied to production:
...
```bash
cd HRMS-DATABASE/HRMS-RewardNRecognition
liquibase status
```
...
-- Should see one row:
-- ID: baseline-existing-db-2026-02-06
-- TAG: baseline-v1.0
```
