...
**az-mcp tools**: `az_get_work_item`, `az_get_work_item_hierarchy_context`, `az_get_work_items`, `az_get_work_item_pull_requests`, `az_list_work_items`, `az_query_work_items`.
